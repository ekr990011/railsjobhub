namespace :cybercoders do
  ...
  task rails: :environment do
    ...
    while @page_count < @multiple_page_count
      pp @multiple_pages_link = "https://www.cybercoders.com" + @page.search(' div.job-listing-container > div.job-listing-item > div.job-details-container > div.job-title')[@page_count].children.at('a').attr("href")
      
      @job_page = @a.get("#{@multiple_pages_link}")
      
      pp @job_title = @job_page.search('div.job-info-content > div.job-info-title > div > h1').text
